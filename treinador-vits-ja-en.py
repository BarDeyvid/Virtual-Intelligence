...
def main():
    ...
    RESTORE_PATH = "Alyssa-VITS-JA-EN-September-14-2025_10+00PM-0000000\\best_model_1504.pth"  # Ou um checkpoint se quiser retreinar
    ...
    alyssa_dataset_config = BaseDatasetConfig(
        ...
        meta_file_train="metadata_fixed.csv",  # Ajuste pro seu arquivo
        meta_file_val="metadata_fixed.csv",    # Use o mesmo se não tiver validação separada
    ...
    audio_config = VitsAudioConfig(
        sample_rate=SAMPLE_RATE,  # Alinhar com WAVs
        hop_length=256,
        win_length=1024,
        fft_size=1024,
        mel_fmin=0.0,
    ...
    config = VitsConfig(
        ...
        use_phonemes=True,
        phonemizer="espeak",
        phoneme_language="ja", # Corrigido aqui
        ...
        characters=CharactersConfig(
            ...
            test_sentences=[
                ["Kyaa! Sugoi match, motto ikuzo!", None, None, "ja"],
                ["Yo, this game’s lit! Let’s clutch!", None, None, "en"], # Corrigido aqui
                ["Ne, kimi no aim, choo kakkoii!", None, None, "ja"],
            ],
            phoneme_cache_path=os.path.join(CURRENT_PATH, "phoneme_cache"), # Corrigido aqui
            ...
            lr=5e-06,  # learning rate, 5e-06 pra conservar, 1e-4 = 0.0001 pra treinar do zero
            lr_scheduler="MultiStepLR",
            # it was adjusted accordingly for the new step scheme
            lr_scheduler_params={"milestones": [50000 * 18, 150000 * 18, 300000 * 18], "gamma": 0.5, "last_epoch": -1},
        ) # lr ajustado para 1e-4 = 0.0001
    ...
    #model = torch.compile(model) # Compilação para otimização (PyTorch 2.0+)
